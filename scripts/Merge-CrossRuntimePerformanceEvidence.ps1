...
$lines.Add('')
$lines.Add('| Engine | Measurements | Geomean vs native Lua | Range |')
$lines.Add('|---|---:|---:|---:|')
foreach ($engine in $aggregateEngines | Sort-Object GeometricMeanSpeedupVsNativeLua -Descending) {
    $lines.Add(('| {0} | {1} | {2:F3}x | {3:F3}x–{4:F3}x |' -f `
...
$lines.Add('')
$lines.Add('| RID | Engine | Workloads | Geomean vs native Lua |')
$lines.Add('|---|---|---:|---:|')
foreach ($row in $perRid) {
    $lines.Add(('| {0} | {1} | {2} | {3:F3}x |' -f `
...
$lines.Add('')
$lines.Add('| Workload | Engine | RIDs | Geomean vs native Lua | Range |')
$lines.Add('|---|---|---:|---:|---:|')
foreach ($row in $perWorkload) {
    $lines.Add(('| {0} | {1} | {2} | {3:F3}x | {4:F3}x–{5:F3}x |' -f `
