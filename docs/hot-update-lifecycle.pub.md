...
[简体中文](hot-update-lifecycle.zh-CN.pub.md)
...
Use the [deployment guide](hot-update.pub.md) for procedures and the
[patch reference](hot-update-reference.pub.md) for exact contracts.
