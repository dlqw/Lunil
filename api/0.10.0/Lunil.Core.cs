...
namespace Lunil.Core
{
    ...
    public readonly struct LuaVersionFeatures : System.IEquatable<Lunil.Core.LuaVersionFeatures>
    {
        ...
        public void Deconstruct(out bool IsImplemented, out Lunil.Core.LuaChunkFormat ChunkFormat, out bool SynchronousFinalizerErrors, out bool SupportsGenerationalCollection, out bool PreservesDeadThreadOpenUpvalues, out bool CachesClosuresByUpvalues, out bool HasWarnLibrary, out bool HasCoroutineClose, out bool HasToBeClosedProtocol, out bool HasUtf8Library, out bool HasBit32Library, out bool HasRawLength, out bool HasGlobalUnpack, out bool HasLoadString, out bool HasModuleLibrary, out bool HasTableMove, out bool HasTablePack, out bool HasTableCreate, out bool HasStringPack, out bool HasStringGFind, out bool HasLegacyMath, out bool HasDebugSetCStackLimit, out bool HasPackageSearchers, out bool HasPackageLoaders, out bool HasPackageSeeAll, out bool HasLegacyTable) => throw null;
    }
