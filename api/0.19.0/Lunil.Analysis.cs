...
namespace Lunil.Analysis
{
    ...
    {
        public static void ScanRuntimeClassEdges(System.ReadOnlySpan<byte> source, System.Collections.Immutable.ImmutableDictionary<string, bool> factoryCalls, [System.Runtime.CompilerServices.TupleElementNames(new string[] { "ClassName", "BaseName" })] System.Collections.Generic.List<System.ValueTuple<string, string?>> edges) { }
        public static bool ScanFactoryNameArgument(System.ReadOnlySpan<byte> source, ref int cursor, out string name) => throw null;
        public static System.Collections.Generic.List<string> ScanFactoryBaseArguments(System.ReadOnlySpan<byte> source, ref int cursor) => throw null;
        public static void ScanClassMixins(System.ReadOnlySpan<byte> source, [System.Runtime.CompilerServices.TupleElementNames(new string[] { "Target", "Source" })] System.Collections.Generic.List<System.ValueTuple<string, string>> mixins) { }
        public static bool IsIdentifierByte(byte value) => throw null;
        public static bool SkipWhitespace(System.ReadOnlySpan<byte> source, ref int cursor, int minimum) => throw null;
        public static bool At(System.ReadOnlySpan<byte> source, ref int cursor, byte value) => throw null;
        public static bool TryReadIdentifier(System.ReadOnlySpan<byte> source, ref int cursor, out string identifier) => throw null;
    }
