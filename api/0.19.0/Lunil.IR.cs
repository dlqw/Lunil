...
namespace Lunil.IR
{
    ...
    {
        public static Lunil.IR.Canonical.LuaIrModule ReadPrototypeModule(Lunil.Core.LuaChunkFormat format, System.ReadOnlySpan<byte> bytes) => throw null;
        public static Lunil.IR.Canonical.LuaIrModule ReadPrototypeModule(Lunil.Core.LuaChunkFormat format, System.ReadOnlySpan<byte> bytes, Lunil.IR.Lua54.Lua54ChunkReaderOptions? options) => throw null;
        public static byte[] WriteCanonicalModule(Lunil.Core.LuaChunkFormat format, Lunil.IR.Canonical.LuaIrModule module, int functionId, bool stripDebug) => throw null;
    }

    public class LuaChunkFormatException : System.FormatException
    {
...
namespace Lunil.IR.Lua51
{
    ...
    public sealed class Lua51ChunkFormatException : Lunil.IR.LuaChunkFormatException
    {
...
namespace Lunil.IR.Lua52
{
    ...
    public sealed class Lua52ChunkFormatException : Lunil.IR.LuaChunkFormatException
    {
...
namespace Lunil.IR.Lua53
{
    ...
    public sealed class Lua53ChunkFormatException : Lunil.IR.LuaChunkFormatException
    {
...
namespace Lunil.IR.Lua54
{
    ...
    public sealed class Lua54ChunkFormatException : Lunil.IR.LuaChunkFormatException
    {
...
namespace Lunil.IR.Lua55
{
    ...
    public sealed class Lua55ChunkFormatException : Lunil.IR.LuaChunkFormatException
    {
