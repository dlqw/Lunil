...
namespace Lunil.Syntax.Lexing
{
    ...
    public sealed class LuaLexResult : System.IEquatable<Lunil.Syntax.Lexing.LuaLexResult>
    {
        ...
        public Lunil.Syntax.Lexing.LuaLexerOptions Options { get => throw null; init { } }
...
namespace Lunil.Syntax.Parsing
{
    ...
    public sealed class LuaCompactSyntaxMetrics : System.IEquatable<Lunil.Syntax.Parsing.LuaCompactSyntaxMetrics>
    {
        public int NodeCount { get => throw null; init { } }
        public int TokenCount { get => throw null; init { } }
        public int TriviaCount { get => throw null; init { } }
        public int ElementCount { get => throw null; init { } }
        public LuaCompactSyntaxMetrics(int NodeCount, int TokenCount, int TriviaCount, int ElementCount) { }
        public override string ToString() => throw null;
        public static bool operator !=(Lunil.Syntax.Parsing.LuaCompactSyntaxMetrics? left, Lunil.Syntax.Parsing.LuaCompactSyntaxMetrics? right) => throw null;
        public static bool operator ==(Lunil.Syntax.Parsing.LuaCompactSyntaxMetrics? left, Lunil.Syntax.Parsing.LuaCompactSyntaxMetrics? right) => throw null;
        public override int GetHashCode() => throw null;
        public override bool Equals(object? obj) => throw null;
        public bool Equals(Lunil.Syntax.Parsing.LuaCompactSyntaxMetrics? other) => throw null;
        public void Deconstruct(out int NodeCount, out int TokenCount, out int TriviaCount, out int ElementCount) => throw null;
    }
    ...
    {
        public static Lunil.Syntax.Parsing.LuaGrammarFeatures Get(Lunil.Core.LuaLanguageVersion version) => throw null;
    }

    public sealed class LuaGrammarFeatures : System.IEquatable<Lunil.Syntax.Parsing.LuaGrammarFeatures>
    {
        public bool SupportsGotoAndLabels { get => throw null; init { } }
        public bool SupportsHexadecimalFloats { get => throw null; init { } }
        public bool SupportsHexadecimalStringEscapes { get => throw null; init { } }
        public bool SupportsWhitespaceEatingStringEscape { get => throw null; init { } }
        public bool SupportsUnicodeStringEscapes { get => throw null; init { } }
        public bool SupportsBitwiseOperators { get => throw null; init { } }
        public bool SupportsFloorDivision { get => throw null; init { } }
        public bool SupportsLocalAttributes { get => throw null; init { } }
        public bool SupportsPrefixAttributes { get => throw null; init { } }
        public bool SupportsGlobalDeclarations { get => throw null; init { } }
        public bool SupportsNamedVarargs { get => throw null; init { } }
        public LuaGrammarFeatures(bool SupportsGotoAndLabels, bool SupportsHexadecimalFloats, bool SupportsHexadecimalStringEscapes, bool SupportsWhitespaceEatingStringEscape, bool SupportsUnicodeStringEscapes, bool SupportsBitwiseOperators, bool SupportsFloorDivision, bool SupportsLocalAttributes, bool SupportsPrefixAttributes, bool SupportsGlobalDeclarations, bool SupportsNamedVarargs) { }
        public override string ToString() => throw null;
        public static bool operator !=(Lunil.Syntax.Parsing.LuaGrammarFeatures? left, Lunil.Syntax.Parsing.LuaGrammarFeatures? right) => throw null;
        public static bool operator ==(Lunil.Syntax.Parsing.LuaGrammarFeatures? left, Lunil.Syntax.Parsing.LuaGrammarFeatures? right) => throw null;
        public override int GetHashCode() => throw null;
        public override bool Equals(object? obj) => throw null;
        public bool Equals(Lunil.Syntax.Parsing.LuaGrammarFeatures? other) => throw null;
        public void Deconstruct(out bool SupportsGotoAndLabels, out bool SupportsHexadecimalFloats, out bool SupportsHexadecimalStringEscapes, out bool SupportsWhitespaceEatingStringEscape, out bool SupportsUnicodeStringEscapes, out bool SupportsBitwiseOperators, out bool SupportsFloorDivision, out bool SupportsLocalAttributes, out bool SupportsPrefixAttributes, out bool SupportsGlobalDeclarations, out bool SupportsNamedVarargs) => throw null;
    }

    public sealed class LuaIncrementalParseMetrics : System.IEquatable<Lunil.Syntax.Parsing.LuaIncrementalParseMetrics>
    {
        public bool WasFullReparse { get => throw null; init { } }
        public string Reason { get => throw null; init { } }
        public Lunil.Core.Text.TextSpan ChangedOldSpan { get => throw null; init { } }
        public Lunil.Core.Text.TextSpan ReparsedNewSpan { get => throw null; init { } }
        public int ReusedNodeCount { get => throw null; init { } }
        public int ReusedTokenCount { get => throw null; init { } }
        public LuaIncrementalParseMetrics(bool WasFullReparse, string Reason, Lunil.Core.Text.TextSpan ChangedOldSpan, Lunil.Core.Text.TextSpan ReparsedNewSpan, int ReusedNodeCount, int ReusedTokenCount) { }
        public override string ToString() => throw null;
        public static bool operator !=(Lunil.Syntax.Parsing.LuaIncrementalParseMetrics? left, Lunil.Syntax.Parsing.LuaIncrementalParseMetrics? right) => throw null;
        public static bool operator ==(Lunil.Syntax.Parsing.LuaIncrementalParseMetrics? left, Lunil.Syntax.Parsing.LuaIncrementalParseMetrics? right) => throw null;
        public override int GetHashCode() => throw null;
        public override bool Equals(object? obj) => throw null;
        public bool Equals(Lunil.Syntax.Parsing.LuaIncrementalParseMetrics? other) => throw null;
        public void Deconstruct(out bool WasFullReparse, out string Reason, out Lunil.Core.Text.TextSpan ChangedOldSpan, out Lunil.Core.Text.TextSpan ReparsedNewSpan, out int ReusedNodeCount, out int ReusedTokenCount) => throw null;
    }
    ...
    public sealed class LuaParseConfiguration : System.IEquatable<Lunil.Syntax.Parsing.LuaParseConfiguration>
    {
        ...
        public LuaParseConfiguration(Lunil.Syntax.Lexing.LuaLexerOptions Lexer, Lunil.Syntax.Parsing.LuaParserOptions Parser) { }
        public override string ToString() => throw null;
        public static bool operator !=(Lunil.Syntax.Parsing.LuaParseConfiguration? left, Lunil.Syntax.Parsing.LuaParseConfiguration? right) => throw null;
        public static bool operator ==(Lunil.Syntax.Parsing.LuaParseConfiguration? left, Lunil.Syntax.Parsing.LuaParseConfiguration? right) => throw null;
        public override int GetHashCode() => throw null;
        public override bool Equals(object? obj) => throw null;
        public bool Equals(Lunil.Syntax.Parsing.LuaParseConfiguration? other) => throw null;
        public void Deconstruct(out Lunil.Syntax.Lexing.LuaLexerOptions Lexer, out Lunil.Syntax.Parsing.LuaParserOptions Parser) => throw null;
    }

    public sealed class LuaParseResult : System.IEquatable<Lunil.Syntax.Parsing.LuaParseResult>
    {
        public Lunil.Core.Text.SourceText Source { get => throw null; }
        public Lunil.Syntax.Parsing.LuaSyntaxNode Root { get => throw null; }
        public System.Collections.Immutable.ImmutableArray<Lunil.Core.Diagnostics.Diagnostic> Diagnostics { get => throw null; }
        public Lunil.Core.LuaLanguageVersion LanguageVersion { get => throw null; init { } }
        public Lunil.Syntax.Parsing.LuaParseConfiguration Configuration { get => throw null; init { } }
        public Lunil.Syntax.Parsing.LuaCompactSyntaxMetrics? CompactMetrics { get => throw null; init { } }
        public Lunil.Syntax.Parsing.LuaIncrementalParseMetrics? IncrementalMetrics { get => throw null; init { } }
    ...
    {
        public static Lunil.Syntax.Parsing.LuaParseResult Parse(Lunil.Core.Text.SourceText source, Lunil.Syntax.Lexing.LuaLexerOptions? lexerOptions = null, Lunil.Syntax.Parsing.LuaParserOptions? parserOptions = null, System.Threading.CancellationToken cancellationToken = null) => throw null;
        public static Lunil.Syntax.Parsing.LuaParseResult Parse(Lunil.Syntax.Lexing.LuaLexResult lexResult, Lunil.Syntax.Parsing.LuaParserOptions? options = null, System.Threading.CancellationToken cancellationToken = null) => throw null;
        public static Lunil.Syntax.Parsing.LuaParseResult ParseIncremental(Lunil.Syntax.Parsing.LuaParseResult previous, Lunil.Syntax.Parsing.LuaTextChange change, Lunil.Syntax.Lexing.LuaLexerOptions? lexerOptions = null, Lunil.Syntax.Parsing.LuaParserOptions? parserOptions = null, System.Threading.CancellationToken cancellationToken = null) => throw null;
    }
    ...
    public sealed class LuaParserOptions : System.IEquatable<Lunil.Syntax.Parsing.LuaParserOptions>
    {
        ...
        public int MaximumDiagnosticCount { get => throw null; init { } }
        public bool UseCompactSyntaxArena { get => throw null; init { } }
        public override string ToString() => throw null;
    ...
    public sealed class LuaTextChange : System.IEquatable<Lunil.Syntax.Parsing.LuaTextChange>
    {
        public Lunil.Core.Text.TextSpan Span { get => throw null; }
        public System.Collections.Immutable.ImmutableArray<byte> NewText { get => throw null; }
        public int Delta { get => throw null; }
        public LuaTextChange(Lunil.Core.Text.TextSpan span, System.Collections.Immutable.ImmutableArray<byte> newText) { }
        public static Lunil.Syntax.Parsing.LuaTextChange FromUtf8(Lunil.Core.Text.TextSpan span, string newText) => throw null;
        public static Lunil.Syntax.Parsing.LuaTextChange FromBytes(Lunil.Core.Text.TextSpan span, System.ReadOnlySpan<byte> newText) => throw null;
        public Lunil.Core.Text.SourceText Apply(Lunil.Core.Text.SourceText source) => throw null;
        public override string ToString() => throw null;
        public static bool operator !=(Lunil.Syntax.Parsing.LuaTextChange? left, Lunil.Syntax.Parsing.LuaTextChange? right) => throw null;
        public static bool operator ==(Lunil.Syntax.Parsing.LuaTextChange? left, Lunil.Syntax.Parsing.LuaTextChange? right) => throw null;
        public override int GetHashCode() => throw null;
        public override bool Equals(object? obj) => throw null;
        public bool Equals(Lunil.Syntax.Parsing.LuaTextChange? other) => throw null;
    }
