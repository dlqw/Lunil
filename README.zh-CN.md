...
<p align="center">
  ...
  <a href="https://github.com/dlqw/Lunil/releases"><img alt="版本" src="https://img.shields.io/badge/version-0.6.0--alpha.5-7c3aed?style=flat-square"></a>
...
> [!IMPORTANT]
> Lunil 当前版本是 **`0.6.0-alpha.5`**。编译器、托管运行时和完整 Lua 5.4 标准库
...
| JIT / AOT 后端 | 预览 | persisted CIL AOT v1、版本化 profile、内容寻址构建缓存、Tier 1/Tier 2 JIT、显式开启的 loop OSR 与六 RID NativeAOT 集成已实现；动态 tier 在性能门槛通过前仍需显式选择 |
