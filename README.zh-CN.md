...
<p align="center">
  ...
  <a href="https://github.com/dlqw/Lunil/releases"><img alt="版本" src="https://img.shields.io/badge/version-0.6.0--alpha.13-7c3aed?style=flat-square"></a>
...
> [!IMPORTANT]
> Lunil 当前版本是 **`0.6.0-alpha.13`**。编译器、托管运行时和完整 Lua 5.4 标准库
...
| JIT / AOT 后端 | 预览 | 已通过资格验证的 Tier 1、精确数值 Tier 2 与带守卫的精确数值 loop OSR 均默认自动启用；所有 managed fallback 路径继续保持显式 opt-in |
