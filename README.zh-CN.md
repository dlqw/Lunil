...
<p align="center">
  ...
  <a href="https://github.com/dlqw/Lunil/releases"><img alt="版本" src="https://img.shields.io/badge/version-0.6.0--alpha.9-7c3aed?style=flat-square"></a>
...
> [!IMPORTANT]
> Lunil 当前版本是 **`0.6.0-alpha.9`**。编译器、托管运行时和完整 Lua 5.4 标准库
...
| JIT / AOT 后端 | 预览 | 已通过资格验证的 Tier 1 与精确数值 Tier 2 默认自动启用；managed-profile Tier 2 与 loop OSR 在更广门槛通过前仍需显式开启 |
...
profile。Loop OSR 则独立通过 `EnableLoopOsr=true` 开启。
