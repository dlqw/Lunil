...
<p align="center">
  ...
  <a href="https://github.com/dlqw/Lunil/releases"><img alt="版本" src="https://img.shields.io/badge/version-0.6.0--alpha.12-7c3aed?style=flat-square"></a>
...
> [!IMPORTANT]
> Lunil 当前版本是 **`0.6.0-alpha.12`**。编译器、托管运行时和完整 Lua 5.4 标准库
...
loop 与 guard widening 路径。动态代码不可用时不会分析、初始化 specialized emitter 或编译 OSR。
