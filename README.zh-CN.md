...
> 当前源码树为 `0.12.0-alpha.11` 热更新预览，不是稳定 package 版本线。
...
- **生产热更新预览**：支持 key 轮换与撤销的签名 Patch Bundle、游戏循环原子发布、状态与资源迁移、
  多 State ring 灰度、具备排他 ownership 与 compaction 生命周期的持久恢复 journal，以及
  .NET telemetry。
