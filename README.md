...
> The current source tree is the `0.12.0-alpha.11` hot-update preview; it is not the stable package
> line.
...
- **Production hot-update preview** — signed Patch Bundles with key rotation and revocation,
  game-loop atomic publication, state and resource migration, multi-State ring rollout, exclusively
  owned and compactable recovery journals, and .NET telemetry.
