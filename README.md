...
<p align="center">
  ...
  <a href="https://github.com/dlqw/Lunil/releases"><img alt="Version" src="https://img.shields.io/badge/version-0.6.0--alpha.13-7c3aed?style=flat-square"></a>
...
> [!IMPORTANT]
> Lunil is currently **`0.6.0-alpha.13`**. The compiler, managed runtime, and complete
...
| JIT / AOT backends | Preview | Qualified Tier 1, exact-numeric Tier 2, and guarded exact-numeric loop OSR are enabled automatically; all managed fallback paths remain explicit opt-ins |
