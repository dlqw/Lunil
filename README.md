...
> The current source tree is the `0.12.0-alpha.12` hot-update preview; it is not the stable package
> line.
...
- **Production hot-update preview** — signed Patch Bundles with key rotation and revocation,
  signer-authorized rollback and capability admission, game-loop atomic publication, state and
