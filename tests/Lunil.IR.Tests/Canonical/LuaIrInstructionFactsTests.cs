...
public sealed class LuaIrInstructionFactsTests
{
    ...
    public static TheoryData<LuaIrOpcode, LuaIrInstructionEffects> OpcodeEffects => new()
    {
        ...
        { LuaIrOpcode.CreateVarArgTable, AllocationSafePoint },
        { LuaIrOpcode.GetVarArg, LuaIrInstructionEffects.None },
        { LuaIrOpcode.ErrorIfNotNil, LuaIrInstructionEffects.MayThrow },
